(function() {
    ...
    publish = function(data, opts, tutorials) {
        ...
        // Assume not global if namespaces
        if (namespaceNames.length) {
            ...
            // Add link for global
            nav += '<li><a href="global.html">Global</a></li>';

        // Assume global if no namespaces
        } else {

            // Add links for App and Helpers namespaces
            nav += '<li><a href="App.html">App</a></li>';
        }
        ...
        if (classNames.length) {
            ...
            classNames.forEach(function(c) {
                ...
                if (!c.memberof || (c.memberof && c.memberof.indexOf('external') !== 0)) {
